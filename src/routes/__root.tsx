  ...
  head: () => ({
    meta: [
      ...
      { title: "Nirikshan AI — Legal Metrology compliance scanning" },
      {
        name: "description",
        content:
          "Scan packaged product labels and verify mandatory declarations under the Legal Metrology (Packaged Commodities) Rules, 2011.",
      },
      { name: "author", content: "Department of Consumer Affairs" },
      { property: "og:title", content: "Nirikshan AI — Scan. Verify. Comply." },
      {
        property: "og:description",
        content: "AI label compliance scanning for enforcement officers and citizens.",
      },
